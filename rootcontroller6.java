...
public class rootcontroller6 implements Initializable {
   ...
   public void initialize(URL location, ResourceBundle resources) {
	...
	ObservableList phoneList = FXCollections.observableArrayList(
    	    new Phone("°¶·°½ÃS1", "phone01.png"),    new Phone("°¶·°½ÃS2", "phone02.png"),
 	    new Phone("°¶·°½ÃS3", "phone03.png"),    new Phone("°¶·°½ÃS4", "phone04.png"),
	...
	tableView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Phone>() {
	    @Override
	    public void changed(ObservableValue<? extends Phone> observable, Phone oldValue, Phone 
				newValue) {
		if(newValue!=null) {
